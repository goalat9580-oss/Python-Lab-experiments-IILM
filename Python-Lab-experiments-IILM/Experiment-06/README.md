...
Traverse the array from the second last element to the first element and shift each element one step to the right.

Place the saved last element at the first index.
